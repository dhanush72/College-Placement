...
<header id="header">
	<!-- <div id="head" class="parallax" parallax-speed="1">
		<h1 id="logo" class="text-center">
			<span class="tagline">
                ...
                $name=$row2['name'];
                ?>
                <img class="img-circle" src="uploaded/<?php echo $name; ?> " height="260" width="260">
                <?php
                echo "<font color=white>"."Welcome"."&nbsp;".$name."</font>";
				?>
                </span>
	...
	<nav class="navbar navbar-default navbar-sticky">
		<div class="container-fluid">
            ...
            $presult = mysqli_query($con,$pending);
            ...
            $pjresult = mysqli_query($con,$pj);
				$pjrow=mysqli_fetch_array($pjresult);

            //Approved students count query
            $aj="select count(jid) from job where approval='yes'";
            $ajresult = mysqli_query($con,$aj);
				$ajrow=mysqli_fetch_array($ajresult);
